    ...
    <div className="min-h-screen bg-dark-bg flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-accent text-sm font-semibold">Admin Portal</p>
        </div>

        {/* Form Card */}
        <form onSubmit={handleSubmit} className="card-base mb-6">
          <h2 className="text-xl font-semibold text-white mb-6">Acesso Administrativo</h2>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="admin@validavolt.com"
              />
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-accent/10 border border-accent/30">
          <p className="text-xs text-accent text-center">
            Portal exclusivo para administradores do ValidaVolt
          </p>
        </div>
      </div>
    </div>
