-- Tabela de Transações/Pagamentos (expandida)
CREATE TABLE IF NOT EXISTS transactions (
  ...
  INDEX idx_infinitepay_id (infinitepay_id)
);
...
-- Tabela de Planos (expandida com preço)
...
-- Tabela de Sessões de Pagamento (temporária para estado do checkout)
...
-- Transações - usuários só podem ver seus próprias
...
-- Webhook Logs - apenas backend pode inserir
...
-- Checkout Sessions - criar e ler próprias sessões
